...
export class UsersService {
     ...
     * @throws ApiError
     */
    public static readUserMeSessions(data: UsersReadUserMeSessionsData = {}): CancelablePromise<UsersReadUserMeSessionsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
